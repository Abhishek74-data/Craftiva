      ...
      <div className="bg-[#FAF8F5] min-h-screen py-8 sm:py-12">
        <div className="wrap">
          ...
          <nav className="flex flex-wrap items-center gap-1.5 text-xs text-[#706A62] mb-6">
            ...
            <Link href={`/categories/${product.category.slug}`} className="hover:text-[#191614]">
        ...
        <section className="border-t border-[#E8E2D8] bg-white py-14">
          <div className="wrap">
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <Link href={`/categories/${product.category.slug}`} className="text-xs font-bold text-[#8C6F47] hover:underline">
