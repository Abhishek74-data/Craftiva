...
echo.
echo [3/4] Committing self-fallback and multi-angle photo assets...
"!GIT_EXE!" commit -m "Fix image cross-fallback, sync all 14 multi-angle product photo sets, and resolve server event handler"
